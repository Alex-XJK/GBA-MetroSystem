 ...
 * <br>
 * By calling {@link metroSystem.Algorithm#findRoute(int, int, DataList)} function you can get the desired optimal route.
 * @since Sept. 30, 2021
 * @version 1
 */
public interface Algorithm {
     ...
     * @param startId   An integer id that refers to the starting MTR station
     * @param endId     An integer id that refers to the ending MTR station
